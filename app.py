...
# =====================================================
# Global CSS Animasi dan Komponen
# =====================================================
st.markdown("""
<style>
/* Title Animasi */
...
if st.session_state.page == "daftarbuku":
    ...
    # ... kode daftar buku sama seperti versi sebelumnya ...
    # (saya tidak ulangi semua bagian buku agar ringkas)
...
# =====================================================
    ...
    # ... kode peminjaman sama seperti versi sebelumnya ...
...
# =====================================================
    ...
    if tema != st.session_state.tema:
        ...
        load_theme_css()  # langsung load CSS baru tanpa rerun
